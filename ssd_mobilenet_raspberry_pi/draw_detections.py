...
def main():
    ...
    image_files = get_files_from_directory(args.images_folder, ".jpg")  # Zmieniamy na .jpg, ale można też na .png
    ...
    for image_file, detection_file in zip(image_files, detection_files):
        ...
        if args.output_folder:
            ...
            output_image_path = os.path.join(args.output_folder,
                                             os.path.splitext(os.path.basename(image_file))[0] + "_detected.jpg")
